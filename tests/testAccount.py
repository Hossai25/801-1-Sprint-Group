...
#<<<<<<< HEAD
    ...
    # Test case 1: All required fields are present
        ...
        self.assertTrue(has_required_fields(data1))
    ...
    # Test case 2: Missing required fields
        ...
        self.assertFalse(has_required_fields(data2))

        # Test case 3: Empty dictionary
        data3 = {}
        self.assertFalse(has_required_fields(data3))
    ...
    #     mock_get_user_model.return_value = mock_user
        ...
        assert valid_login(email_attempt, password_attempt) == True

    # Test case 2: Invalid email
        assert valid_login("invalid@example.com", password_attempt) == False
    ...
    #     mock_user.password = "password123"
    #     mock_get_user_model.return_value = mock_user
        assert valid_login(email_attempt, "wrongpassword") == False
